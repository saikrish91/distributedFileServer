...
public class WorkMessageUtils {
	...
	public static WorkMessage createHB(EdgeInfo ei) {
		...
		if(ServerState.state == ServerLeaderElectionState.LEADER)
			bb.setServerState("Leader");
		else if(ServerState.state == ServerLeaderElectionState.CANDIDATE)
			bb.setServerState("Candidate");
		else if(ServerState.state == ServerLeaderElectionState.FOLLOWER)
			bb.setServerState("Follower");
