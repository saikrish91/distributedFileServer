		...
		//	System.out.println("Inside dbreadrequest");
			...
			for(File chunk : fileChunks) {
					if(messageType.equals("command")) {
						...
						System.out.println("Inside elseif global");
						...
						System.out.println("sending filechunk");
